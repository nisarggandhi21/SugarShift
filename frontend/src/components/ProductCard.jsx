...
function ProductCard({ product, onAddToCart, onOpenProduct }) {
  ...
  return (
    <div
      ...
      className="relative flex cursor-pointer flex-col overflow-hidden rounded-2xl border-2 border-line bg-surface shadow-hard transition hover:-translate-x-0.5 hover:-translate-y-0.5"
    >
      {discount && (
      ...
      <div className="flex flex-1 flex-col gap-1 p-3.5">
        ...
        <button type="button" className="btn btn-accent mt-auto w-full" onClick={handleAdd}>
